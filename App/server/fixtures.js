...
let addSheets = function(cArray, sheets){
    for(let i = 0; i < 5; i++){
        ...
        sheets.push({class: MAGED.Classes[type], obj:{_id: new Meteor.Collection.ObjectID().toJSONValue(),dynamic: Math.random() > 0.5, h: 1+Math.round(Math.random()*10), b: 0, _class: type}});
    }
    //order by rarity
